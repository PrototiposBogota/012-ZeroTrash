...
<header class="main-header">
    ...
    <a href="{{ url('/home') }}" class="logo">
        ...
        <span class="logo-mini"><b>Z</b>T</span>
        <!-- logo for regular state and mobile devices -->
        <span class="logo-lg"><b>Zero</b> Trash</span>
    </a>
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-header">
                                ...
                                <p>
                                    ...
                                    <small><i class="fa fa-circle text-success"></i> {{ trans('adminlte_lang::message.online') }}</small>
                                </p>
                            </li>
                            <!-- Menu Body -->
                            {{--<li class="user-body">--}}
