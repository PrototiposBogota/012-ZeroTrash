            ...
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" method="POST" action="{{route('cars.update', $cars->id)}}">
                            {{ csrf_field() }}
                            ...
                            <div class="form-group{{ $errors->has('description') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="description" type="text" class="form-control" name="description" value="{{$cars->description}}" placeholder="Ingrese la descripcion del Carro" required autofocus>
                            ...
                            <div class="form-group{{ $errors->has('mark') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="mark" type="text" class="form-control" name="mark" value="{{$cars->mark}}" placeholder="Ingrese la Marca" required autofocus>
                            ...
                            <div class="form-group{{ $errors->has('capacity') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="capacity" type="text" class="form-control" name="capacity" value="{{$cars->capacity}}" placeholder="Ingrese la Capacidad del Carro" required autofocus>
